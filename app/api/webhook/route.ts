  ...
  try {
    ...
    // 💬 Logic: คุยกับ AI
      ...
      const messages: OpenAI.ChatCompletionMessageParam[] = [
        {
          role: 'system',
          content: `คุณคือ "น้องเรียนดี" เพื่อนสนิทวัยรุ่น ตอบสั้นๆ 1-2 ประโยค ใช้ภาษาวัยรุ่นเป็นกันเอง (เรา/แก) ไม่สั่งสอน แค่รับฟังและให้กำลังใจ${user.nickname ? ` เพื่อนชื่อ ${user.nickname}` : ''}`
        }
      ];
